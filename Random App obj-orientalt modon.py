...
#------------------------------------------------------------------------------------------------------------
    ...
    def translate(self):
        ...
        if word in dict.keys():
            mb.showwarning(title="Dictionary'S message", message=dict.get(word))
            

            

        else:
            mb.showwarning(title="Warning", message="There is no such a word there yet, or you just typed wrong!")
